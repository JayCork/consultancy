...
export const AllZero: Story = {
  args: {
    counts: { total: 0, draft: 0, pending_verification: 0, verified: 0 },
  },
};

export const DraftsOnly: Story = {
  args: {
    counts: { total: 3, draft: 3, pending_verification: 0, verified: 0 },
    onSubmitDrafts: () => {},
  },
};
...
export const Mixed: Story = {
  args: {
    counts: { total: 12, draft: 2, pending_verification: 3, verified: 7 },
    onSubmitDrafts: () => {},
  },
};
...
export const AllVerified: Story = {
  args: {
    counts: { total: 8, draft: 0, pending_verification: 0, verified: 8 },
  },
};
